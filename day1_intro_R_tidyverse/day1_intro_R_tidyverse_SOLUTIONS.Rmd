...
```{r exercise_3_1_paired_contrasts, message = FALSE, warning = FALSE, cols.print = 12}
# paired contrasts
ex31.posthoc.att <-
...
```{r exercise_3_2_paired_contrasts, message = FALSE, cols.print = 12}
...
With these exercises, I tried to give you a glimpse of the versatility, readability, and user-friendliness of the ```tidyverse```.   
   
In the second part of the morning, [Ivan Grahek](https://www.researchgate.net/profile/Ivan_Grahek) 
   
In the afternoon, [Ladislas Nalborczyk](http://www.barelysignificant.com/)
