...
This is a hands-on introduction of the ```tidyverse```, a collection of **R** pacakages for data manipulation and plotting. There is no time to cover all the amazing things you can do with these packages. If you want to learn more, I suggest [R for Data Science](http://r4ds.had.co.nz/) by [Garrett Grolemund](https://www.oreilly.com/pub/au/5570) and [Hadley Wickham](http://hadley.nz/).
...
The graphs above suggest that negative imagery may have influenced ratings to *water* more than to beer. It is time to statistically verify our hypothesis.

# Data analysis

The aim of this study was to assess whether negative imagery would influence the likeness ratings of alcoholic beverages. We will now run a 2 (**drink**: water, beer) x 2 (**imagery** neutral, negative) repeated measures ANOVA on these ratings.   
...
The output has all you need to report in a publication... well, almost.
