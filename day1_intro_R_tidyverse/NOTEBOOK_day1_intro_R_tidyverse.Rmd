...
A better solution is to use **RDI** plots, which show **R**aw data, **D**escriptive and **I**nferential statistics.   
...
[^1]: This dataset is part of the book [Discovering Statistics Using R (Field, Miles & Field, 2012)](https://www.discoveringstatistics.com/books/discovering-statistics-using-r/).
